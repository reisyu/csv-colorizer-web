...
- **視点プリセット** — 「正面」(立面図SVGと同じ向き)・「全体」ボタンでワンクリック移動
...
- **現在のビューSVG書き出し** — 立面図とは別に、現在のカメラの向き・ズームをそのまま使い、
  画面に見えている通りの遠近感(パースあり)でベクター書き出し。凡例・ラベル・傾きラインの
  設定は立面図と共通。距離により見かけの縮尺が変わるためスケールバーは非対応
